...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let sRoot = this.attachShadow({mode:"open"});
		...
		sRoot.append(styleElem);
		sRoot.append(articleElem);
	}
	...
	set data(data) {
		...
		// let recipe = document.querySelector("recipe-card");
		let recipe = this;
		let sRoot = recipe.shadowRoot;
		let articleElem = sRoot.querySelector('article');
